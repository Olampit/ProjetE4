...
int main(int argc, char** argv)
{
    ...
    //Set center frequency to 284 MHz
    if (LMS_SetLOFrequency(device, LMS_CH_RX, 0, 284e6) != 0)
        error();
	...
	*/
	//
	FILE *f = fopen("iq_output.bin","wb");
	fwrite(buffer, sizeof(int16_t), samplesRead, f);
	fclose(f);  
